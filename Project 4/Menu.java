        ...
        do {
            ...
            if (userCASIOption.equals("1")) {
                ...
                try {
                    ...
                    System.out.println("Please ensure you have a usernames.txt file and an account has been created." +
        ...
        do {
            ...
            if (userResponse.equals("1")) {
                            ...
                            do {
                                ...
                                if (edit.equals("1")) {
                                    ...
                                    if (choice.equals("1")) {
                                        ...
                                        System.out.println("Please enter a valid input from 1-3");
                                    }
                ...
                if (c == null) {
                    ...
                    try {
                        ...
                        while (line == null || line.equals("")) {
                            System.out.println("The question prompt was " + line);
                            pw.print(line + "\t");
                            line = br.readLine();
                            System.out.println("This question was worth " + line + " points");
                            pw.println(line + " points");
                            line = br.readLine();
                            System.out.println("The student responded with " + line);
                ...
                try {
                    ...
                    System.out.println("Can't delete account right now.");
                    return false;
                }
            ...
            if (userResponse.equals("1")) {
                ...
                if (courseList.size() == 0) {
                    ...
                    while (courseIndex(courseName) == -1) {
                        System.out.println("Please select a valid course (case sensitive).");
                        courseName = s.nextLine();
                    }
                    ...
                    if (!courseList.get(index).hasQuizzes()) {
                        ...
                        while (courseList.get(index).getQuiz(quizName) == null) {
                            System.out.println("Please select a valid quiz (case sensitive).");
                            quizName = s.nextLine();
                        }
    ...
    private void createAccount() {
        ...
        do {
            try {
                ...
                System.out.println("Please ensure you have a usernames.txt file created and run the program again.");
            }
        } while (cont);
    }
